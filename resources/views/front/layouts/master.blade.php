...
<body>
    ...
    <!--======================================================
            Intro Section
        ======================================================-->
    <section id='intro' class='main-section parallax' data-parallax='scroll'
        data-image-src='{{ asset('front/img/bg.jpg') }}'>
            ...
            <div class='row'>
                ...
                <div class='col-md-6'>
                    ...
                    <div class='intro-text'>
                        ...
                        <p class='font-alt wow fadeInUp' data-wow-delay='.4s'>You’ve got things to do! We’ve got
                            options!</p>
                ...
                <div class='col-md-6'>
                    ...
                    <div class='mockup'>
                        <img src='{{ asset('front/img/mockup1-front.png') }}' class='front wow fadeInDown'
                            data-wow-duration='.7s' data-wow-delay='1.6s' alt>
                        <img src='{{ asset('front/img/mockup1-back.png') }}' class='back wow fadeInDown'
                            data-wow-duration='.7s' data-wow-delay='1.3s' alt>
                    </div>
            ...
            <div class='row'>
                ...
                <div class='col-md-7'>
                    ...
                    <div class='screens-mockup'>
                        <img class='phone wow fadeInUp' data-wow-duration='.8s' data-wow-delay='.2s'
                            src='{{ asset('front/img/mockup2-phone.png') }}' alt>
                        <img class='screen wow fadeIn' data-wow-delay='1s'
                            src='{{ asset('front/img/mockup2-screen1.png') }}' alt>
                        <img class='screen wow fadeIn' data-wow-delay='1.4s'
                            src='{{ asset('front/img/mockup2-screen2.png') }}' alt>
                        <img class='screen wow fadeIn' data-wow-delay='1.8s'
                            src='{{ asset('front/img/mockup2-screen3.png') }}' alt>
                    </div>
                ...
                <div class='col-md-5'>
                    ...
                    <div class='mockup-text'>
                        ...
                        <p class='wow fadeInUp' data-wow-delay='.6s'>
                            Support your local restaurants and grocery stores by ordering the food you enjoy, delivered
                            straight to your door.
                        </p>

                        <a href='https://www.youtube.com/watch?v=1piFN_ioMVI&ab_channel=BumrungradInternationalHospital'
                            class='btn-custom arrow-btn wow fadeInUp' data-wow-delay='.8s' target='_blank'>
                            Watch Video
            ...
            <div class='row'>
                ...
                <div class='col-md-7 col-md-push-5'>
                    ...
                    <div class='mockup-shadow'>
                        <img class='shadow wow fadeIn' data-wow-delay='.4s' data-wow-offset='200'
                            data-wow-duration='1.2s' src='{{ asset('front/img/mockup3-shadow.png') }}' alt>
                        <img class='phone wow fadeInDown' data-wow-delay='.2s' data-wow-offset='200'
                            data-wow-duration='1.2s' src='{{ asset('front/img/mockup3-phone.png') }}' alt>
                    </div>
                ...
                <div class='col-md-5 col-md-pull-7'>
                    ...
                    <div class='mockup-text'>
                        ...
                        <p class='wow fadeInUp' data-wow-delay='.6s'>
                            Share our app with others and earn cash each time your friends make a purchase. XP Eats,
                            sharing is caring!
                        </p>
            ...
            <div class='row'>
                ...
                <div class='col-md-4'>
                    ...
                    <div class='mockup wow fadeInUp' data-wow-delay='.2s'>
                        <img src='{{ asset('front/img/mockup4.png') }}' alt>
                    </div>
    ...
    <section id='screenshots' class='screenshots-section'>
        <div class='container'>
            ...
            <ul class='screenshots-slider wow fadeInRight' data-wow-delay='.6s'>
                ...
                <li>
                    <figure>
                        <img src='{{ asset('front/img/screens/1.jpg') }}' alt>
                        <div class='overlay'>
                            <a href='{{ asset('front/img/screens/1.jpg') }}' class='view-btn'></a>
                        </div>
                    </figure>
                </li>
                ...
                <li>
                    <figure>
                        <img src='{{ asset('front/img/screens/2.jpg') }}' alt>
                        <div class='overlay'>
                            <a href='{{ asset('front/img/screens/2.jpg') }}' class='view-btn'></a>
                        </div>
                    </figure>
                </li>
                ...
                <li>
                    <figure>
                        <img src='{{ asset('front/img/screens/3.jpg') }}' alt>
                        <div class='overlay'>
                            <a href='{{ asset('front/img/screens/3.jpg') }}' class='view-btn'></a>
                        </div>
                    </figure>
                </li>
                ...
                <li>
                    <figure>
                        <img src='{{ asset('front/img/screens/4.jpg') }}' alt>
                        <div class='overlay'>
                            <a href='{{ asset('front/img/screens/4.jpg') }}' class='view-btn'></a>
                        </div>
                    </figure>
                </li>
                ...
                <li>
                    <figure>
                        <img src='{{ asset('front/img/screens/5.jpg') }}' alt>
                        <div class='overlay'>
                            <a href='{{ asset('front/img/screens/5.jpg') }}' class='view-btn'></a>
                        </div>
                    </figure>
                </li>
                ...
                <li>
                    <figure>
                        <img src='{{ asset('front/img/screens/6.jpg') }}' alt>
                        <div class='overlay'>
                            <a href='{{ asset('front/img/screens/6.jpg') }}' class='view-btn'></a>
                        </div>
                    </figure>
                </li>
    ...
    <!--======================================================
            Video Section
        ======================================================-->
    <section id='video' class='video-section parallax' data-parallax='scroll'
        data-image-src='{{ asset('front/img/bg-mockup.jpg') }}'>
        <div class='container'>
            <div class='row'>
                <div class='col-md-4 col-sm-6'>
                    ...
                    <div class='watch-video'>
                        ...
                        <a href='https://www.youtube.com/watch?v=1piFN_ioMVI&ab_channel=BumrungradInternationalHospital'
                            class='play-btn wow bounceIn' data-wow-delay='.2s' target='_blank'>
    ...
    <section id='features-4' class='features-2-section'>
        <div class='container'>
            ...
            <div class='mockup'>
                <img class='shadow wow zoomIn animated' src='{{ asset('front/img/perspective-shadow.png') }}' alt>
                <img class='phone wow fadeInDown animated' src='{{ asset('front/img/perspective-phone.png') }}' alt>
            </div>
            ...
            <div class='download-app'>
                ...
                <div class='download-btns'>
                    ...
                    <a href='#' class='wow bounceIn' data-wow-delay='.4s'target='_blank'>
                        <img src='{{ asset('front/img/android.png') }}' alt>
                    </a>

                    <a href='#' class='wow bounceIn' data-wow-delay='.6s'target='_blank'>
                        <img src='{{ asset('front/img/apple.png') }}' alt>
                    </a>
    ...
    <section id='contact' class='contact-section'>
        <div class='container'>
            ...
            <div class='section-header text-center'>
                ...
                <p class='wow fadeInUp' data-wow-delay='.4s'>If you've got any questions, mail us, we will get in
                    touch</p>
            </div>
                ...
                <div class='col-md-8 col-md-offset-2'>
                    ...
                    <form id='contact-form' name='contactForm' class='contact-form' data-toggle='validator'>
                        ...
                        <div class='row'>
                            <div class='col-md-6'>
                                ...
                                <div class='form-group'>
                                    <input type='text' class='form-control wow fadeInUp' data-wow-delay='.4s'
                            ...
                            <div class='col-md-6'>
                                ...
                                <div class='form-group'>
                                    <input type='email' class='form-control wow fadeInUp' data-wow-delay='.5s'
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class='form-group'>
                                    <input type='text' class='form-control wow fadeInUp' data-wow-delay='.6s'
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input class="form-control wow fadeInUp" data-wow-delay='.5s' type="tel"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class='form-group'>
                                    <textarea class='form-control wow fadeInUp' data-wow-delay='.8s' name='message' placeholder='Message'
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="g-recaptcha" data-sitekey="6LdZx8IZAAAAAAAlGt8-l3896LuhgvjQwfscvyMS">
                                </div>
                            </div>
